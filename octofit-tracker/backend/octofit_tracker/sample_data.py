test_data = {
    ...
    "activities": [
        {"user": "thundergod", "activity_type": "Cycling", "duration": "1:00"},
        {"user": "metalgeek", "activity_type": "Crossfit", "duration": "2:00"},
        {"user": "zerocool", "activity_type": "Running", "duration": "1:30"},
        {"user": "crashoverride", "activity_type": "Strength", "duration": "0:30"},
        {"user": "sleeptoken", "activity_type": "Swimming", "duration": "1:15"},
    ],
    "leaderboard": [
